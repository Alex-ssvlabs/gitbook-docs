...
If you do not need to do this programmatically, it may be easier to use the [Ethereum Staking Deposit CLI](https://github.com/ethstaker/ethstaker-deposit-cli) to generate validator keys.
